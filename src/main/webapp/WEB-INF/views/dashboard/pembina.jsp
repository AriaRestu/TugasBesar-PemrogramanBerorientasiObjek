...
<head>
<meta charset="UTF-8"/>
<title>Dashboard Pembina - TEL-U</title>
    ...
    <div class="inner">
        <div class="hero">
            <div class="hero-text">
                ...
                <p>Selamat datang di Peminjaman Ruang TEL-U. Berikut pengajuan yang menunggu persetujuan Anda.</p>
            </div>
        </div>
        ...
        <div class="cards">
            <div class="card">
                ...
                <div>
                    ...
                    <div class="card-num">${pengajuanList != null ? pengajuanList.size() : 0}</div>
                </div>
            </div>
            <div class="card">
        ...
        <div class="table-box">
            <div class="table-header">
                ...
                <a href="${pageContext.request.contextPath}/approval/pembina" class="btn-success">
                    <i class="fa-solid fa-square-check"></i> Proses Semua
                </a>
            </div>
            <table>
                <thead>
                        ...
                        <c:otherwise>
                            <c:forEach var="p" items="${pengajuanList}">
                                <tr>
                                    ...
                                    <td>${p.keperluan}</td>
                                    <td><span class="badge pending">MENUNGGU PEMBINA</span></td>
                                </tr>
                            </c:forEach>
                        </c:otherwise>
                    </c:choose>
