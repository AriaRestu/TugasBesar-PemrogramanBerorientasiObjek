...
<head>
<meta charset="UTF-8"/>
<title>Dashboard SSC - TEL-U</title>
    ...
    <div class="inner">
        <div class="hero">
            <div class="hero-text">
                ...
                <p>Selamat datang di Peminjaman Ruang TEL-U. Berikut pengajuan yang menunggu verifikasi SSC.</p>
            </div>
        </div>
        ...
        <div class="cards">
            <div class="card">
                ...
                <div>
                    ...
                    <div class="card-num">${pendingCount != null ? pendingCount : 0}</div>
                </div>
            </div>
            <div class="card">
        ...
        <div class="table-box">
            <div class="table-header">
                <h2>Pengajuan Menunggu Verifikasi SSC</h2>
                <a href="${pageContext.request.contextPath}/approval/ssc" class="btn-success">
                    <i class="fa-solid fa-calendar-check"></i> Proses Semua
                </a>
            </div>
            <table>
                <thead>
                ...
                <tbody>
                    <c:choose>
                        <c:when test="${empty pengajuanList}">
                            <tr><td colspan="6" style="text-align:center;padding:40px;color:#aaa;">Tidak ada pengajuan yang menunggu verifikasi.</td></tr>
                        </c:when>
                        <c:otherwise>
                            <c:forEach var="p" items="${pengajuanList}">
                                <tr>
                                    ...
                                    <td>${p.keperluan}</td>
                                    <td><span class="badge pending">MENUNGGU SSC</span></td>
                                </tr>
                            </c:forEach>
                        </c:otherwise>
                    </c:choose>
